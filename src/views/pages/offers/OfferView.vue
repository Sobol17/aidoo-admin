...
const progressValue = computed(() => {
	return (correctFields.value.length / Object.keys(formFields.value).length) * 100
})
</script>
		...
		<div v-else class="grid">
			<div class="col-12 md:col-4 lg:col-3">
				<Card class="h-full">
					...
					<template #title>
						<div class="text-left">
							<h3 class="text-xl mt-0 mb-2">Предложение</h3>
			...
			<div class="col-12 md:col-8 lg:col-9 mt-4">
				<Card>
					<template #content>
						<h3>Детальная информация о предложении</h3>
