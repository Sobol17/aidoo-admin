export const formatPhoneNumber = (value) => {
  ...
  if (value.startsWith("8") || value.startsWith("7")) {
    if (numbers.length <= 1) return "8";
    if (numbers.length <= 4) return `8 (${numbers.slice(1)}`;
    if (numbers.length <= 7)
      return `8 (${numbers.slice(1, 4)}) ${numbers.slice(4)}`;
    if (numbers.length <= 9)
      return `8 (${numbers.slice(1, 4)}) ${numbers.slice(4, 7)}-${numbers.slice(7)}`;
  ...
  if (numbers.length <= 6)
    return `8 (${numbers.slice(0, 3)}) ${numbers.slice(3)}`;
  if (numbers.length <= 8)
    return `8 (${numbers.slice(0, 3)}) ${numbers.slice(3, 6)}-${numbers.slice(6)}`;
