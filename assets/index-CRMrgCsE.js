import{B as e,c as t,o,h as s,m as r,s as l}from"./index-B9WMAgPp.js";var f=({dt:n})=>`
.p-iconfield {
    position: relative;
}
...
`,$={root:"p-iconfield"},m=e.extend({name:"iconfield",style:f,classes:$}),u={name:"BaseIconField",extends:l,style:m,provide:function(){return{$pcIconField:this,$parentInstance:this}}},h={name:"IconField",extends:u,inheritAttrs:!1};function g(n,p,a,c,d,i){return o(),t("div",r({class:n.cx("root")},n.ptmi("root")),[s(n.$slots,"default")],16)}h.render=g;var v={root:"p-inputicon"},x=e.extend({name:"inputicon",classes:v}),z={name:"BaseInputIcon",extends:l,style:x,props:{class:null},provide:function(){return{$pcInputIcon:this,$parentInstance:this}}},I={name:"InputIcon",extends:z,inheritAttrs:!1,computed:{containerClass:function(){return[this.cx("root"),this.class]}}};function y(n,p,a,c,d,i){return o(),t("span",r({class:i.containerClass},n.ptmi("root")),[s(n.$slots,"default")],16)}I.render=y;export{I as a,h as s};
